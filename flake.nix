      ...
      (system:
        let
          ...
          release = terraform: pkgs.runCommand "release-tarball"
            ...
            mkdir -p $out
            mkdir tf-ncl
            ${lib.concatLines (lib.flip lib.mapAttrsToList (schemas terraform) (provider: schema: ''
          ...
          } // lib.mapAttrs' (name: value: lib.nameValuePair "schema-${name}" value) (schemas terraform);
          ...
          devShell = terraform: pkgs.mkShell {
            inputsFrom = builtins.attrValues (checks terraform);
          ...
          generateJsonSchema = terraform: providerFn: pkgs.callPackage
            ...
            { inherit terraform; inherit (packages terraform) schema-merge; };

          generateSchema = terraform: providerFn: pkgs.callPackage
            ./nix/nickel_schema.nix
            { jsonSchema = (generateJsonSchema terraform) providerFn; inherit (packages terraform) tf-ncl; };
